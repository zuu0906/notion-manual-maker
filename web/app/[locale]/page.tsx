          ...
          <div className="hero-grid">
            <div>
              ...
              <div className="cta-row">
                ...
                <a href="https://github.com/zuu0906/notion-manual-api/releases" className="btn btn-ghost btn-lg" target="_blank" rel="noopener noreferrer">
      ...
      <section className="section" id="desktop" style={{ background: 'var(--bg-2)', borderTop: '1px solid var(--line)', borderBottom: '1px solid var(--line)' }}>
        <div className="lp-container">
          ...
          <div style={{ marginTop: 32, display: 'flex', alignItems: 'center', gap: 16 }}>
            <a href="https://github.com/zuu0906/notion-manual-api/releases" target="_blank" rel="noopener noreferrer"
