    ...
    <section className="max-w-3xl mx-auto px-4 py-20">
      ...
      <div className="flex flex-col gap-10 text-sm text-gray-700 leading-relaxed">
        ...
        <div>
          ...
          <p>記録されたスクリーンショットはサーバーを経由してNotionページに保存されます。アップロード完了後はNotionページから参照される公開URLとして扱われます。</p>
          <p className="mt-2">個人情報の自動ぼかし機能（メールアドレス・電話番号・クレジットカード番号・パスワード欄など）は、お使いのデバイス上のみで処理され、サーバーには送信されません。</p>
        </div>
        <div>
          <h2 className="text-base font-semibold text-gray-900 mb-3">5. データの保存期間</h2>
        ...
        <div>
          <h2 className="text-base font-semibold text-gray-900 mb-3">6. 第三者サービス</h2>
          ...
          <ul className="mt-2 flex flex-col gap-1 list-disc list-inside text-gray-600">
            ...
            <li>Stripe（決済処理）</li>
            <li>Google Gemini AI（AI説明文生成）</li>
          </ul>
        </div>
        <div>
          <h2 className="text-base font-semibold text-gray-900 mb-3">7. Cookieの使用</h2>
          <p>本サービスはセッション管理のためにCookieおよびlocalStorageを使用します。トラッキング目的のCookieは使用しません。</p>
        </div>
        <div>
          <h2 className="text-base font-semibold text-gray-900 mb-3">8. ポリシーの変更</h2>
          <p>本ポリシーは必要に応じて変更することがあります。重要な変更がある場合はサービス内でお知らせします。変更後も継続して利用する場合は変更に同意したものとみなします。</p>
        </div>
        <div>
          <h2 className="text-base font-semibold text-gray-900 mb-3">9. お問い合わせ</h2>
    ...
    <section className="max-w-3xl mx-auto px-4 py-20">
      ...
      <div className="flex flex-col gap-10 text-sm text-gray-700 leading-relaxed">
        ...
        <div>
          ...
          <p>Recorded screenshots are saved to your Notion page via our servers. Once uploaded, they are treated as public URLs referenced from your Notion page.</p>
        ...
        <div>
          ...
          <ul className="mt-2 flex flex-col gap-1 list-disc list-inside text-gray-600">
            ...
            <li>Google Gemini AI (AI caption generation)</li>
          </ul>
        </div>
        <div>
        ...
        <div>
          <h2 className="text-base font-semibold text-gray-900 mb-3">8. Policy Updates</h2>
